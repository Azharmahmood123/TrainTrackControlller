...
public class PairedDevicesAdapter extends RecyclerView.Adapter<PairedDevicesAdapter.PairedDevicesViewHolder> {

    private List<BluetoothObject> bluetoothObjectList;
    private final OnItemClickListener onItemClickListener;

    public PairedDevicesAdapter(List<BluetoothObject> bluetoothObjectList, OnItemClickListener onItemClickListener) {
    ...
    public PairedDevicesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_paired_bluetooth_devices, parent, false);
    ...
    public void onBindViewHolder(@NonNull PairedDevicesViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> onItemClickListener.onPairedItemClick(holder.getAdapterPosition()));
    }
    ...
    public interface OnItemClickListener {
        void onPairedItemClick(int position);
    }
}
